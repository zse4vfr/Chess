...
public class GameTask {
        ...
        switch(number)
        {
            ...
            case 4 :
                if(cell_begin.figure.getName().compareTo("Q") == 0 && cell_end.name().compareTo("h7") == 0 && number_of_move == 1) {
                    MoveLogic(cell_begin, cell_end);//если полльзователь выбрал ферзя и хочет сходить им на клетку h7 и это первый ход, то делаем этот ход
                    number_of_move++;//прибавляем кол-во ходов

                    ResetFigures(Cell.f8, Cell.h7);//компьютер отвечает единственно возможным ходом, сначала логически
                    MoveGraphic(Cell.f8, Cell.h7);//а потом графику рисуем
                }
                else if(cell_begin.figure.getName().compareTo("R") == 0 && cell_end.name().compareTo("g6") == 0 && number_of_move == 2) {
                    MoveLogic(cell_begin, cell_end);//если пользователь выбрал ладью и хочет сходить на g6 и это второй ход, то делаем этот ход
                    OpenWinWindow();//и выводим окно с сообщением об успешности решения
                }
                else
                    OpenIncorrectMoveWindow();//иначе выводим окно с сообщение о неправильности хода
            ...
            case 6 :
                ...
                break;
            case 7 :
                if(cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("c6") == 0 && number_of_move == 1) {
                    MoveLogic(cell_begin, cell_end);
                    number_of_move++;
                    a = Math.random() * 2;
                    random1 = (int) a;
                    if (random1 == 0) {
                        ResetFigures(Cell.b8, Cell.a8);
                        MoveGraphic(Cell.b8, Cell.a8);
                    } else if (random1 == 1) {
                        ResetFigures(Cell.b7, Cell.c6);
                        MoveGraphic(Cell.b7, Cell.c6);
                    }
                }
                else if(number_of_move == 2 && random1 == 0 && cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("c7") == 0) {
                    MoveLogic(cell_begin, cell_end);
                    OpenWinWindow();
                }
                else if(number_of_move == 2 && random1 == 1 && cell_begin.figure.getName().compareTo("R") == 0 && cell_end.name().compareTo("b3") == 0) {
                    MoveLogic(cell_begin, cell_end);
                    number_of_move++;
                    ResetFigures(Cell.b8, Cell.a8);
                    MoveGraphic(Cell.b8, Cell.a8);
                }
                else if(number_of_move == 3 && random1 == 1 && cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("c7") == 0) {
                    MoveLogic(cell_begin, cell_end);
                    OpenWinWindow();
                }
                else
            ...
            case 8 :
                ...
                break;
            case 9 :
                if(cell_begin.figure.getName().compareTo("R") == 0 && cell_end.name().compareTo("a1") == 0 && number_of_move == 1) { // делаем первый ход только при выборе ладьи с конечной клеткой а1
                    MoveLogic(cell_begin, cell_end); //делаем ход, меняя местами два поля
                    number_of_move++; //прибавляем счетчик ходов
                    a = Math.random() * 3; //рандомим значение переменной для выбора хода
                    random1 = (int) a;
                    if (random1 == 0) { // компьютер делает ход в зависимости от значения рандома
                        ResetFigures(Cell.d4, Cell.a1); //ход компьютера,переставляем фигуры
                        MoveGraphic(Cell.d4, Cell.a1); //меняем графику
                    } else if (random1 == 1) {
                        ResetFigures(Cell.a2, Cell.a1);
                        MoveGraphic(Cell.a2, Cell.a1);
                    }
                    else if (random1 == 2) {
                        ResetFigures(Cell.a2, Cell.a1);
                        MoveGraphic(Cell.a2, Cell.a1);
                ...
                else if(number_of_move == 2 && random1 == 0 && cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("b4") == 0) { // делаем ход только при выборе коня с конечной клеткой b4 при нужных значениях кол-ва ходов и рандома
                    MoveLogic(cell_begin, cell_end); //делаем выбранный ход
                    OpenWinWindow(); //открываем окно, которое сообшает о решении задачи
                }
                else if(number_of_move == 2 && random1 == 1 && cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("d4") == 0) { // делаем ход только при выборе коня с конечной клеткой d4 при нужных значениях кол-ва ходов и рандома
                    MoveLogic(cell_begin, cell_end); //делаем выбранный ход
                    number_of_move++;
                    ResetFigures(Cell.a3, Cell.a2); //ход компьютера, переставляем фигуры
                    MoveGraphic(Cell.a3, Cell.a2); //меняем графику
                }
                else if(number_of_move == 3 && random1 == 1 && cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("b3") == 0) { // делаем ход только при выборе коня с конечной клеткой d4 при нужных значениях кол-ва ходов и рандома
                    MoveLogic(cell_begin, cell_end); //делаем выбранный ход
                    OpenWinWindow();
                }
                else if(number_of_move == 2 && random1 == 2 && cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("d4") == 0) { // делаем ход только при выборе коня с конечной клеткой d4 при нужных значениях кол-ва ходов и рандома
                    MoveLogic(cell_begin, cell_end); //делаем выбранный ход
                    number_of_move++;
                    ResetFigures(Cell.a1, Cell.a2); //ход компьютера, переставляем фигуры
                    MoveGraphic(Cell.a1, Cell.a2); //меняем графику
                }
                else if(number_of_move == 3 && random1 == 2 && cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("e2") == 0) { // делаем ход только при выборе коня с конечной клеткой e2 при нужных значениях кол-ва ходов и рандома
                    MoveLogic(cell_begin, cell_end); //делаем выбранный ход
                    number_of_move++;
                    ResetFigures(Cell.a2, Cell.a1); //ход компьютера, переставляем фигуры
                    MoveGraphic(Cell.a2, Cell.a1); //меняем графику
                }
                else if(number_of_move == 4 && random1 == 2 && cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("c1") == 0) { // делаем ход только при выборе коня с конечной клеткой c1 при нужных значениях кол-ва ходов и рандома
                    MoveLogic(cell_begin, cell_end); //делаем выбранный ход
                    number_of_move++;
                    ResetFigures(Cell.a3, Cell.a2); //ход компьютера, переставляем фигуры
                    MoveGraphic(Cell.a3, Cell.a2); //меняем графику
                }
                else if(number_of_move == 5 && random1 == 2 && cell_begin.figure.getName().compareTo("N") == 0 && cell_end.name().compareTo("b3") == 0) { // делаем ход только при выборе коня с конечной клеткой b3 при нужных значениях кол-ва ходов и рандома
                    MoveLogic(cell_begin, cell_end); //делаем выбранный ход
                    OpenWinWindow(); //открываем окно, которое сообшает о решении задачи
                }
                else
                    OpenIncorrectMoveWindow(); //открываем окно, которое сообшает о неправильном ходе
    ...
    public void ArrangementLogic3() {
        ...
        Cell.g2.figure = new Pawn("P", FigureColor.WHITE);
        Cell.e1.figure = new Bishop("B", FigureColor.BLACK);
